...
class Automata():
	...
	def createAutomata(self):
		...
		guiSubautomata6.newGuiNode(13, 0, 341, 163, 0, 'FollowRed')
	...
	def subautomata6(self):
		...
		while(self.run6):
			...
			if(self.sub1 == "FollowRed"):
				if ((self.sub6 == "WaitRed_ghost") or (self.sub6 == "FollowRed_ghost")):
