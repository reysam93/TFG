				...
				if (!t_activated) {
					...
					if (secs > (double) 2) {
						...
						if (displayAutomataGui){
							automatagui->setNodeAsActive("GoBack", true);
							automatagui->setNodeAsActive("GoFront", false);
						}
					}
				}
			...
			case GoBack: {
				if (!t_activated) {
					...
					if (secs > (double) 2) {
						...
						t_activated = false;
						if (displayAutomataGui){
							automatagui->setNodeAsActive("Turn", true);
							automatagui->setNodeAsActive("GoBack", false);
						}
					}
				}
				...
				if (angle > 45) {
					sub_1 = Wait;
						if (displayAutomataGui){
							...
							automatagui->setNodeAsActive("Turn", false);
						}
				}
			...
			case Wait: {
				if (!t_activated) {
					...
					if (secs > (double) 1) {
						...
						t_activated = false;
						if (displayAutomataGui){
							automatagui->setNodeAsActive("GoFront", true);
